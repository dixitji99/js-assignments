...
function encodeToRot13(str) {
    const x = str.split('');
    const y = x.map(ele => {
        if (ele.charCodeAt() > 64 && ele.charCodeAt() < 91) {
            if ((ele.charCodeAt() + 13) > 90)
                return (ele.charCodeAt() + 13) % 91 + 65;
            return (ele.charCodeAt() + 13);
        }
        else if (ele.charCodeAt() > 96 && ele.charCodeAt() < 123) {
            if ((ele.charCodeAt() + 13) > 122)
                return (ele.charCodeAt() + 13) % 123 + 97;
            return (ele.charCodeAt() + 13);
        }
        else {
    ...
    return y.map(ele => String.fromCharCode(ele)).join("");
}
